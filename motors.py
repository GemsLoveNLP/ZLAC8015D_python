...
class Motors:
    ...
    def __init__(self, front_port="/dev/ttyUSB0"):

        # initialize drivers
        front = ZLAC8015D(port=front_port)
        # rear = ZLAC8015D(port=rear_port)
...
def main():
    ...
    motors = Motors(front_port="/dev/ttyUSB0")
    ...
    while True:
        ...
        print(motors.get_rpms())
        print(motors.get_delta_travelled())
